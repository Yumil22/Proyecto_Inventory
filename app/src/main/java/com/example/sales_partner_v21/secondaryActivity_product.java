...
public class secondaryActivity_product extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondary_product);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        secondaryActivity_product.super.finish();
    }
}
